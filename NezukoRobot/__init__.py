...
def get_user_list(__init__, key):
    with open("{}/NezukoRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[NezukoRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[NezukoRobot]')
...
if ENV:
    ...
    from NezukoRobot.config import Development as Config
...
from NezukoRobot.modules.helper_funcs.handlers import (
