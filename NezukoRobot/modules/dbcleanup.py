...
import NezukoRobot.modules.sql.global_bans_sql as gban_sql
import NezukoRobot.modules.sql.users_sql as user_sql
from NezukoRobot import DEV_USERS, OWNER_ID, dispatcher
