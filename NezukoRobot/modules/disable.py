...
from NezukoRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from NezukoRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from NezukoRobot.modules.sql import disable_sql as sql
