...
import NezukoRobot.modules.sql.welcome_sql as sql
from NezukoRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from NezukoRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from NezukoRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from NezukoRobot.modules.helper_funcs.msg_types import get_welcome_type
from NezukoRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from NezukoRobot.modules.log_channel import loggable
from NezukoRobot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_photo(
                MIKU, caption= "My Boyfriend just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [                  
                       InlineKeyboardButton(
                             text="Support🚑",
                             url=f"https://t.me/akira_suppory"),
                       InlineKeyboardButton(
                             text="Updates🛰️",
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("NezukoRobot.modules." +
                                              module_name)
